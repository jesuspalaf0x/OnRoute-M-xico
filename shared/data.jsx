...
const COPY = {
  es: {
    ...
    destinos: {
      ...
      list: [
        { n: 'Tulum', m: '2h 00min desde CUN', img: 'uploads/Imagenes para sitio/ruinas-tulum-frente-al-mar-caribe-zona-arqueologica.jpg' },
        { n: 'Cancún', m: 'Zona Hotelera · 20min', img: 'uploads/Imagenes para sitio/playa-delfines-mirador-cancun-arena-blanca.jpg' },
        { n: 'Playa del Carmen', m: '1h 10min desde CUN', img: 'uploads/Imagenes para sitio/portal-maya-playa-del-carmen-parque-fundadores.jpg' },
        { n: 'Chichén Itzá', m: '3h 00min desde CUN', img: 'uploads/Imagenes para sitio/piramide-kukulcan-chichen-itza-tour-yucatan.jpg' },
        { n: 'Holbox', m: '2h 40min + ferry', img: 'uploads/Imagenes para sitio/calle-principal-isla-holbox-tour-quintana-roo.jpg' },
        { n: 'Bacalar', m: '4h 30min desde CUN', img: 'uploads/Imagenes para sitio/laguna-bacalar-siete-colores-tour-quintana-roo.jpg' },
        { n: 'Valladolid', m: '2h 15min desde CUN', img: 'uploads/Imagenes para sitio/catedral-san-servacio-valladolid-yucatan-pueblo-magico.jpg' },
        { n: 'Mérida', m: '4h 00min desde CUN', img: 'uploads/Imagenes para sitio/jarana-yucateca-baile-tradicional-merida.jpg' },
      ],
    },
    tours: {
  ...
  en: {
    ...
    destinos: {
      ...
      list: [
        { n: 'Tulum', m: '2h 00min from CUN', img: 'uploads/Imagenes para sitio/ruinas-tulum-frente-al-mar-caribe-zona-arqueologica.jpg' },
        { n: 'Cancún', m: 'Hotel Zone · 20min', img: 'uploads/Imagenes para sitio/playa-delfines-mirador-cancun-arena-blanca.jpg' },
        { n: 'Playa del Carmen', m: '1h 10min from CUN', img: 'uploads/Imagenes para sitio/portal-maya-playa-del-carmen-parque-fundadores.jpg' },
        { n: 'Chichén Itzá', m: '3h 00min from CUN', img: 'uploads/Imagenes para sitio/piramide-kukulcan-chichen-itza-tour-yucatan.jpg' },
        { n: 'Holbox', m: '2h 40min + ferry', img: 'uploads/Imagenes para sitio/calle-principal-isla-holbox-tour-quintana-roo.jpg' },
        { n: 'Bacalar', m: '4h 30min from CUN', img: 'uploads/Imagenes para sitio/laguna-bacalar-siete-colores-tour-quintana-roo.jpg' },
        { n: 'Valladolid', m: '2h 15min from CUN', img: 'uploads/Imagenes para sitio/catedral-san-servacio-valladolid-yucatan-pueblo-magico.jpg' },
        { n: 'Mérida', m: '4h 00min from CUN', img: 'uploads/Imagenes para sitio/jarana-yucateca-baile-tradicional-merida.jpg' },
      ],
    },
    tours: {
